...
PREFIX_CATEGORY_WORDS: Dict[str, EventCategory] = {
    ...
    "pagopa": EventCategory.BILL,
    "f24": EventCategory.BILL,
    "bollo": EventCategory.BILL,
    "tassa": EventCategory.BILL,
    "tasse": EventCategory.BILL,
    "imu": EventCategory.BILL,
    "tari": EventCategory.BILL,
    "telepass": EventCategory.BILL,
    "subscription": EventCategory.BILL,
    "abbonamento": EventCategory.BILL,
    "mortgage": EventCategory.BILL,
    "mutuo": EventCategory.BILL,
    "insurance": EventCategory.BILL,
    "assicurazione": EventCategory.BILL,
}
...
ANCHOR_CATEGORY_MAP: Dict[str, EventCategory] = {
    ...
    "bolletta": EventCategory.BILL,
    "bollette": EventCategory.BILL,
    "tax": EventCategory.BILL,
    "taxes": EventCategory.BILL,
    "tassa": EventCategory.BILL,
    "tasse": EventCategory.BILL,
    "pagopa": EventCategory.BILL,
    "f24": EventCategory.BILL,
